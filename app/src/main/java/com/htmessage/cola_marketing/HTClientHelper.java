...
import com.htmessage.cola_marketing.activity.chat.call.VideoIncomingActivity;
import com.htmessage.cola_marketing.activity.chat.call.VideoOutgoingActivity;
import com.htmessage.cola_marketing.activity.chat.call.VoiceIncomingActivity;
...
public class HTClientHelper {
    ...
    private HTClientHelper(Context context) {
