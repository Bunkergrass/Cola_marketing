...
public class PreferenceManager {
    ...
    private static String STATE_SHOPS_AUTHORIZATION="state_shops_authorization";
    private static String STATE_ENTREPRENEURSHIP_AUTHORIZATION="state_entrepreneurship_authorization";
    ...
    public boolean haveShopsAuthorizationYet(){
        return mSharedPreferences.getBoolean(STATE_SHOPS_AUTHORIZATION, false);
    }

    public void setShopsAuthorizationYet(){
        editor.putBoolean(STATE_SHOPS_AUTHORIZATION, true);
        editor.commit();
    }

    public boolean haveEntrepreneurshipAuthorizationYet(){
        return mSharedPreferences.getBoolean(STATE_ENTREPRENEURSHIP_AUTHORIZATION, false);
    }

    public void setEntrepreneurshipAuthorizationYet(){
        editor.putBoolean(STATE_ENTREPRENEURSHIP_AUTHORIZATION, true);
        editor.commit();
    }
}
