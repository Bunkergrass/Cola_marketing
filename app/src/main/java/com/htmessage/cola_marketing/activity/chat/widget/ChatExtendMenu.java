...
public class ChatExtendMenu extends GridView {
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        setVerticalSpacing(DensityUtil.dp2px(context, 8));
    }
    ...
    class ChatMenuItem extends LinearLayout {
        ...
        private void init(Context context, AttributeSet attrs) {
            ...
            imageView = (ImageView) findViewById(R.id.iv_chatmenu_image);
            textView = (TextView) findViewById(R.id.tv_chatmenu_text);
        }
