...
import com.htmessage.cola_marketing.activity.chat.file.adapter.TViewHolder;
...
public class FileBrowserActivity extends BaseActivity implements TAdapterDelegate {
    ...
    // constant
    private static final String ROOT_PATH = Environment.getExternalStorageDirectory().getPath() + "/DCIM/Camera";
