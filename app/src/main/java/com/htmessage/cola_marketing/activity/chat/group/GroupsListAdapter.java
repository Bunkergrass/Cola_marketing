...
public class GroupsListAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        RequestOptions options = new RequestOptions().diskCacheStrategy(DiskCacheStrategy.ALL).placeholder(R.drawable.default_group).error(R.drawable.default_group);
        Glide.with(context).load(item.getImgUrl()).apply(options).into(holder.iv_avatar);
        return view;
    }
