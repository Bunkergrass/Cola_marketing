...
import com.htmessage.cola_marketing.activity.common.KeepAliveActivity;
...
//                CusActivityManager.getInstance().finishAllActivity();
    ...
    private void showUpdateDialog(final Context context, String title, String message, final String url) {
        ...
        View dialogView = View.inflate(context, R.layout.dialog_alert, null);
        ...
        tv_forward_content.setText(message);
