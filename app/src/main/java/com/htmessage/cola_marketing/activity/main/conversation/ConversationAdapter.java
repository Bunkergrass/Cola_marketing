...
public class ConversationAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (holder == null) {
            ...
            holder.tv_content = convertView.findViewById(R.id.message);
            holder.tv_time = convertView.findViewById(R.id.time);
            holder.tv_unread = convertView.findViewById(R.id.unread_msg_number);
            holder.ivAvatar = convertView.findViewById(R.id.avatar);
            holder.tv_group_tag = convertView.findViewById(R.id.tv_group_tag);
        ...
        if (chatType == ChatType.groupChat) {
            ...
            if (htGroup != null) {
                ...
                RequestOptions options1 = new RequestOptions().diskCacheStrategy(DiskCacheStrategy.ALL).placeholder(R.drawable.default_group);
                Glide.with(context).load(htGroup.getImgUrl()).apply(options1).into(holder.ivAvatar);
            }else {
                //如果当前群还未获取到,
