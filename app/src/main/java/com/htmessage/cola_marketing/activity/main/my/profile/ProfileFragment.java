...
import com.htmessage.cola_marketing.activity.main.my.update.ProfileUpdateActivity;
...
public class ProfileFragment extends Fragment implements ProfileView, View.OnClickListener{
    ...
    private void initData() {
        ...
        Glide.with(getBaseContext()).load(avatarUrl).apply(options).into(iv_avatar);
    ...
    public void onAvatarUpdate(String avatar, boolean isHang) {
        ...
        Glide.with(getBaseContext()).load(avatar).apply(options).into(iv_avatar);
    }
