...
public class MomentsFragment extends Fragment implements MomentsContract.View, SwipyRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        pullToRefreshListView = root.findViewById(R.id.pull_refresh_list);
        actualListView = root.findViewById(R.id.refresh_list);
        pullToRefreshListView.setOnRefreshListener(this);
        reEdittext = root.findViewById(R.id.re_edittext);
        etComment = reEdittext.findViewById(R.id.et_comment);
        buttonSend = reEdittext.findViewById(R.id.btn_send);
        return root;
    }
        ...
        buttonSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(comment)) {
                    Toast.makeText(getActivity(),R.string.input_talks,Toast.LENGTH_SHORT).show();
                    return;
                }
