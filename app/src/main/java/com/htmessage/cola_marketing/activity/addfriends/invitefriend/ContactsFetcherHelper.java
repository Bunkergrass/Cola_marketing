...
public class ContactsFetcherHelper implements Runnable {
    ...
    public static void queryContactInfo(final Context context, final OnContactsHasListener listener) {
        final Dialog dialog = HTApp.getInstance().createLoadingDialog(context, context.getString(R.string.loading));
        dialog.show();
...
//                        cci.setLetter(cursor.getString(sort_key_index));
                       ...
                       // Log.d("ContactsFetcherHelper","name::"+cursor.getString(nameFieldColumnIndex)+"phoneNum:: "+strPhoneNumber);
...
//                null, null);
//        Log.d("ContactsFetcherHelper", ">>>>>>" + cursor.getCount());
...
//            Log.d("ContactsFetcherHelper", ">>>>>>" + "_id=" + id+ "  name=" + name + "  phone number=" + phoneNumber);
//        }
...
//                    Log.d("ContactsFetcherHelper","name::"+mime+"phoneNum:: "+data1);
//                }
//            }
//        }
//        cursor.close();
        ...
        try {
            ...
            if (cursor != null) {
                while (!mCancel && cursor.moveToNext()) {
                   ...
                   // Log.d("ContactsFetcherHelper2","name::"+cursor.getString(nameIndex)+"phoneNum:: "+number);
               ...
               // Log.d("ContactsFetcherHelper2","cursor is null");
            }
        } catch (Exception e) {
            if (cursor != null)
                cursor.close();
