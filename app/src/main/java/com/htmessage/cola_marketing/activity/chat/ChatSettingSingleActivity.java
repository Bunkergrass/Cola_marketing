...
//        }
    ...
    private void initData() {
        ...
        ImageView ivAvatar= this.findViewById(R.id.iv_avatar);
        TextView tvNick = this.findViewById(R.id.tv_username);
...
//        String avatarUrl = HTConstant.URL_AVATAR + userJson.getString(HTConstant.JSON_KEY_AVATAR);
        ...
        Glide.with(this).load( avatarUrl).apply(options).into(ivAvatar);

        ivAvatar.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
//                startActivity(new Intent(ChatSettingSingleActivity.this, UserDetailsActivity.class)
//                        .putExtra(HTConstant.KEY_USER_INFO, user.getUserInfo()));
            }
        });
        ImageView ivAdd = this.findViewById(R.id.iv_avatar2);
