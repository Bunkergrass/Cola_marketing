...
public class NewFriendsAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.item_new_friend, null);
        }
        ...
        if (holder == null) {
            ...
            holder.tv_added = convertView.findViewById(R.id.tv_added);
            holder.btn_add = convertView.findViewById(R.id.btn_add);
            holder.rl_item_add = convertView.findViewById(R.id.rl_item_add);
