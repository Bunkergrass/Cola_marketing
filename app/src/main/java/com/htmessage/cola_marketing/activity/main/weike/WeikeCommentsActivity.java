...
public class WeikeCommentsActivity extends BaseActivity implements SwipyRefreshLayout.OnRefreshListener, WeikeContract.DetailView {
    ...
    public void sendCommentSuccess() {
        ...
        manager.hideSoftInputFromWindow(et_weike_commment.getWindowToken(),InputMethodManager.HIDE_IMPLICIT_ONLY);
    }
    ...
    @Override
    public void sendReplySuccess(int pos, JSONObject data) {
